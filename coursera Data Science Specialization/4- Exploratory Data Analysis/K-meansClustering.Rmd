...
kmeansObj <- kmeans(dataFrame,centers=3) #list with number of deffrent elemnt in it 
names(kmeansObj)
kmeansObj$cluster
kmeansObj$centers
```
...
image(t(dataMatrix)[,nrow(dataMatrix):1],yaxt="n") #the orginal data the right 
image(t(dataMatrix)[,order(kmeansObj$cluster)],yaxt="n") # reorder with k mean the left 
```
