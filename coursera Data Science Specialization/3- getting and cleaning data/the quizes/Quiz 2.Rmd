...
myapp <- oauth_app(appname = "mohey",
                   key = "bf5b95721ed19101b36c",
                   secret = "259a66710823a6e5ebd87577edd1df658e953f30")
...
acs <- data.table::data.table(read.csv('getdata%2Fdata%2Fss06pid.csv'))
```
